...
public:
     ...
     * @see     delTask
     */
    HMCErrCode addTask(int32_t tid, int32_t iSampleKT, std::string strVarList);
     ...
     * @see     addTask
     */
    HMCErrCode delTask(int32_t tid);
     ...
     * @see     start
     */
    HMCErrCode stop(int32_t tid);

    /**
     * @brief   获取存在的采集任务列表
     * @param[out]  listTask        采集任务ID列表
     */
    HMCErrCode getExistTasks(std::vector<int32_t> & listTask);
	
    /**
     * @brief   获取正在运行的采集任务列表
     * @param[out]  listTask        采集任务ID列表
     */
    HMCErrCode getRunningTasks(std::vector<int32_t> & listTask);
     ...
     */
    HMCErrCode getCurTimestamp(int32_t & timestamp);
