...
public:
     ...
     */
	HMCErrCode queryError(uint64_t errCode, std::string & strReason, std::string & strElim);
     ...
     */
    HMCErrCode getMessage(ErrLevel & level, uint64_t & code, std::string & strMsg, uint32_t ulWaitTime);
	 ...
	 * @param   strLang     语言名
     */
	HMCErrCode setLang(const std::string & strLang);
