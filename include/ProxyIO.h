...
public:
     ...
     */
	HMCErrCode getDinGrp(int32_t grpIndex, uint32_t & num);
     ...
     */
	HMCErrCode getDoutGrp(int32_t grpIndex, uint32_t & num);
     ...
     * @see     setDinMaskBit
     */
	HMCErrCode getDinMaskGrp(int32_t grpIndex, uint32_t & num);
     ...
     * @see     setDoutMaskBit
     */
	HMCErrCode getDoutMaskGrp(int32_t grpIndex, uint32_t & num);
     ...
     */
    HMCErrCode contactOnHook(const std::string & strIntent, const std::string & strMsg, std::string & strResponse);
